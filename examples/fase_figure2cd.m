...
function fase_figure2cd()
    ...
    for N_ind = 1:numel(Ns)
        figure(fig_id);
        hold on;
        loglog(ns, mean(mae_mt2_mean(:,N_ind,:), 3), ...
            'color', colors{1}, ...
            'linewidth', linewidth, ...
            'linestyle', '-', ...
            'marker', 's', ...
            'markersize', markersize);
        loglog(ns, mean(mae_mt1(:,N_ind,:), 3), ...
            'color', colors{2}, ...
            'linewidth', linewidth, ...
            'linestyle', '-', ...
            'marker', 'o', ...
            'markersize', markersize);
        loglog(ns, mean(mae_mt2_proj(:,N_ind,:), 3), ...
            'color', colors{3}, ...
            'linewidth', linewidth, ...
            'linestyle', '-', ...
            'marker', '*', ...
            'markersize', markersize);
        loglog(ns, mean(mae_mt2_oracle_proj(:,N_ind,:), 3), ...
            'color', colors{4}, ...
            'linewidth', linewidth, ...
            'linestyle', '-', ...
            'marker', 'd', ...
