% FASE_FIGURE3CD Generate Figure 3b and 3d from the FASE paper
%
% Usage
%    fase_figure3bd(empiar10028_location);
%
% Input
%    location: The location in which the EMPIAR-10028 dataset is stored
%       (default 'data/empiar10028').
%
% Description
%    Generate Figures 3b and 3d from
%
%       J. Andén and A. Singer, "Factor Analysis for Spectral Estimation,"
%       submitted to SampTA 2017, arXiv preprint arXiv:1702.04672.

function data = fase_figure3bd(empiar10028_location)
    if nargin < 1 || isempty(empiar10028_location)
        empiar10028_location = 'data/empiar10028';
    end
    ...
    x = read_empiar10028(empiar10028_location);
    ...
    x_mt_proj1 = x_mt_proj(:,:,12131);
    x_mt_proj2 = x_mt_proj(:,:,48841);
    ...
    set(gca, 'xtick', [1 16], 'ytick', [0 5e-6 10e-6], ...
        'yticklabel', {'0', '5e-6', '1e-5'});
